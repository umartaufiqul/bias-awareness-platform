...
c.NotebookApp.tornado_settings = { 'headers': { 'Content-Security-Policy': "frame-ancestors 'self' http://172.10.6.40:3000/" } }
...
#  Choices: any of ['sha256', 'blake2b', 'sha3_256', 'sha512', 'sha384', 'sha224', 'md5', 'sha1', 'sha3_512', 'sha3_224', 'blake2s', 'sha3_384']
#  Default: 'sha256'
